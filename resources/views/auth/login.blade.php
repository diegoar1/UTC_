...
<div class="container space-2">
	  ...
	  @csrf
        ...
        <div class="js-form-message form-group">
          <label for ="email" class="form-label" for="signinSrEmail">Nomina/Matricula/Correo</label>
          <input id="email" type="email" class="form-control" name="email" id="signinSrEmail" placeholder="Nomina/Matricula/Correo" aria-label="Email address" required value="{{ old('email') }}"	
        ...
        <!-- Form Group -->
        <div class="js-form-message form-group">
          <label for="password" class="form-label" for="signinSrPassword">
            <span class="d-flex justify-content-between align-items-center">
            Contraseña
              <!-- <a class="link-muted text-capitalize font-weight-normal" href="recover-account-simple.html">Forgot Password?</a> -->
            </span>
          </label>
          <input id="password" type="password" class="form-control" name="password" id="signinSrPassword" placeholder="********" aria-label="********" required
